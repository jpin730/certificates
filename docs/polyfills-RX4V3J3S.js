;(function (e) {
  ...
  let se = class se {
    ...
    scheduleMicroTask(t, s, o, v) {
      return this.scheduleTask(new p(N, t, s, o, v, void 0))
    }
    scheduleMacroTask(t, s, o, v, F) {
      return this.scheduleTask(new p(P, t, s, o, v, F))
    }
    scheduleEventTask(t, s, o, v, F) {
      return this.scheduleTask(new p(K, t, s, o, v, F))
    }
    cancelTask(t) {
      if (t.zone != this)
        throw new Error(
    ...
    constructor(t, s, o, v, F, f) {
      ...
      t === K && v && v.useG
        ...
        : (this.invoke = function () {
            return p.invokeTask.call(e, u, this, arguments)
          })
    }
...
var Je = typeof WorkerGlobalScope < 'u' && self instanceof WorkerGlobalScope,
  ...
  qe = function (e) {
    ...
    if (Ge && c === Te && e.type === 'error') {
      ...
      (a = r && r.apply(this, arguments)), a != null && !a && e.preventDefault()
    return a
  }
function Xe(e, n, c) {
  let r = ge(e, n)
  if (
    (!r && c && ge(c, n) && (r = { enumerable: !0, configurable: !0 }),
    !r || !r.configurable)
  )
    return
  ...
  b || (b = Pe[_] = A('ON_PROPERTY' + _)),
    (r.set = function (k) {
      let p = this
      if ((!p && e === Y && (p = Y), !p)) return
      typeof p[b] == 'function' && p.removeEventListener(_, qe),
        y && y.call(p, null),
        (p[b] = k),
        typeof k == 'function' && p.addEventListener(_, qe, !1)
    }),
    (r.get = function () {
      let k = this
...
Zone.__load_patch('ZoneAwarePromise', (e, n, c) => {
  ...
  function z(f, u, i) {
    ...
    if (f[q] === M) {
      let m = null
      try {
        ;(typeof i == 'object' || typeof i == 'function') && (m = i && i.then)
      } catch (w) {
        return (
          h(() => {
            z(f, !1, w)
      ...
      if (
        ...
        ne(i), z(f, i[q], i[R])
      else if (u !== x && typeof m == 'function')
        try {
          m.call(i, h(N(f, u)), h(N(f, !1)))
        } catch (w) {
          h(() => {
            z(f, !1, w)
          })()
        ...
        if (
          ...
          let g = n.currentTask && n.currentTask.data && n.currentTask.data[I]
          g &&
            a(i, oe, {
              configurable: !0,
              enumerable: !1,
        ...
        for (let g = 0; g < w.length; ) ee(f, w[g++], w[g++], w[g++], w[g++])
        if (w.length == 0 && u == x) {
          f[q] = d
          let g = i
          try {
...
` + i.stack
  ...
  function ee(f, u, i, h, m) {
    ne(f)
    let w = f[q],
      g = w ? (typeof h == 'function' ? h : j) : typeof m == 'function' ? m : J
    u.scheduleMicroTask(
      X,
      () => {
        try {
          let C = f[R],
            S = !!i && E === i[E]
          S && ((i[$] = C), (i[H] = w))
          let D = u.run(g, void 0, S && g !== J && g !== j ? [] : [C])
          z(i, !0, D)
        } catch (C) {
          z(i, !1, C)
        }
  ...
  class t {
    ...
    static any(u) {
      ...
      let i = [],
        h = 0
      try {
        for (let g of u) h++, i.push(t.resolve(g))
      } catch {
        return Promise.reject(new L([], 'All promises were rejected'))
      }
      if (h === 0)
        ...
        for (let S = 0; S < i.length; S++)
          i[S].then(
            ...
            (D) => {
              w.push(D),
                h--,
                h === 0 && ((m = !0), C(new L(w, 'All promises were rejected')))
            }
          )
      })
    }
    static race(u) {
      ...
      for (let C of u) B(C) || (C = this.resolve(C)), C.then(w, g)
      return m
    }
    static all(u) {
    ...
    static allWithCallback(u, i) {
      ...
      for (let D of u) {
        ...
        try {
          D.then(
            (V) => {
              ;(S[G] = i ? i.thenCallback(V) : V), g--, g === 0 && h(S)
            },
            (V) => {
              i ? ((S[G] = i.errorCallback(V)), g--, g === 0 && h(S)) : m(V)
            }
          )
        } catch (V) {
          m(V)
    ...
    then(u, i) {
      ...
      let m = new h(se),
        w = n.current
      return this[q] == M ? this[R].push(w, m, u, i) : ee(this, w, m, u, i), m
    }
    catch(u) {
      ...
      h[E] = E
      let m = n.current
      return this[q] == M ? this[R].push(m, h, u, u) : ee(this, m, h, u, u), h
    }
  }
  ;(t.resolve = t.resolve),
    (t.reject = t.reject),
  ...
  function J(R, E) {
    ...
    let ne = function (i) {
          ...
          if (w) {
            for (let g = 0; g < w.length; g++)
              if (w[g] === i) {
                w.splice(g, 1),
                  (i.isRemoved = !0),
                  w.length === 0 && ((i.allRemoved = !0), (i.target[m] = null))
                break
              }
          }
        }
      ...
      o = function (i, h) {
        let m = typeof h
        return (
          (m === 'function' && i.callback === h) ||
          (m === 'object' && i.originalDelegate === h)
        )
      },
      v = E && E.diff ? E.diff : o,
      F = Zone[A('UNPATCHED_EVENTS')],
      f = e[A('PASSIVE_EVENTS')],
      u = function (i, h, m, w, g = !1, C = !1) {
        return function () {
          let S = this || e,
            D = arguments[0]
          ...
          We && (ve = We[D]),
            ...
            (d.isExisting = Be)
          let pe = $ ? _t : void 0
          pe && (pe.taskData = d), ye && (d.options.signal = void 0)
          let ie = it.scheduleEventTask(ve, G, pe, m, w)
          if (
            (ye &&
              ((d.options.signal = ye),
              i.call(
    ...
    return (
      (T[a] = u(N, k, t, s, M)),
      z && (T[p] = u(z, I, se, s, M, !0)),
      (T[l] = function () {
        let i = this || e,
          h = arguments[0]
        E && E.transferEventName && (h = E.transferEventName(h))
        let m = arguments[2],
          w = m ? (typeof m == 'boolean' ? !0 : m.capture) : !1,
          g = arguments[1]
        if (!g) return P.apply(this, arguments)
        if (H && !H(P, g, i, arguments)) return
        let C = te[h],
          S
        C && (S = C[w ? ce : ae])
        let D = S && i[S]
...
function ot(e, n) {
  if (!n) {
    ...
    for (let y in e) {
      ...
      if (b && (!n || b === n)) {
        let k = e[y]
        if (k) for (let p = 0; p < k.length; p++) l.push(k[p])
      }
    }
    return l
  }
        ...
        a.forEach(function (p) {
          ...
          try {
            if (O.hasOwnProperty(p)) {
              let Z = e.ObjectGetOwnPropertyDescriptor(O, p)
              Z && Z.value
                ? ((Z.value = e.wrapWithCurrentZone(Z.value, I)),
                  e._redefineProperty(b.prototype, p, Z))
                : O[p] && (O[p] = e.wrapWithCurrentZone(O[p], I))
            } else O[p] && (O[p] = e.wrapWithCurrentZone(O[p], I))
          } catch {}
        }),
      y.call(n, _, b, k)
    )
...
Zone.__load_patch('util', (e, n, c) => {
  ...
  e[l] && (e[a] = e[l]),
    ...
    (c.ObjectGetOwnPropertyDescriptor = ge),
    (c.ObjectCreate = ct),
    (c.ArraySlice = at),
    (c.patchClass = ke),
